...
export const usSicCodes = [
  { code: "100", description: "AGRICULTURAL PRODUCTION-CROPS" },
  {
    code: "200",
    description: "AGRICULTURAL PROD-LIVESTOCK & ANIMAL SPECIALTIES",
  },
  { code: "700", description: "AGRICULTURAL SERVICES" },
  { code: "800", description: "FORESTRY" },
  { code: "900", description: "FISHING, HUNTING AND TRAPPING" },
  { code: "1000", description: "METAL MINING" },
  { code: "1040", description: "GOLD AND SILVER ORES" },
  { code: "1090", description: "MISCELLANEOUS METAL ORES" },
  { code: "1220", description: "BITUMINOUS COAL & LIGNITE MINING" },
  { code: "1221", description: "BITUMINOUS COAL & LIGNITE SURFACE MINING" },
  { code: "1311", description: "CRUDE PETROLEUM & NATURAL GAS" },
  { code: "1381", description: "DRILLING OIL & GAS WELLS" },
  { code: "1382", description: "OIL & GAS FIELD EXPLORATION SERVICES" },
  { code: "1389", description: "OIL & GAS FIELD SERVICES, NEC" },
  {
    code: "1400",
    description: "MINING & QUARRYING OF NONMETALLIC MINERALS (NO FUELS)",
  },
  { code: "1520", description: "GENERAL BLDG CONTRACTORS - RESIDENTIAL BLDGS" },
  ...
  { code: "1700", description: "CONSTRUCTION - SPECIAL TRADE CONTRACTORS" },
  ...
  { code: "2013", description: "SAUSAGES & OTHER PREPARED MEAT PRODUCTS" },
  { code: "2015", description: "POULTRY SLAUGHTERING AND PROCESSING" },
  { code: "2020", description: "DAIRY PRODUCTS" },
  { code: "2024", description: "ICE CREAM & FROZEN DESSERTS" },
  {
    code: "2030",
  ...
  { code: "2040", description: "GRAIN MILL PRODUCTS" },
  { code: "2050", description: "BAKERY PRODUCTS" },
  { code: "2052", description: "COOKIES & CRACKERS" },
  { code: "2060", description: "SUGAR & CONFECTIONERY PRODUCTS" },
  { code: "2070", description: "FATS & OILS" },
  { code: "2080", description: "BEVERAGES" },
  { code: "2082", description: "MALT BEVERAGES" },
  {
    code: "2086",
  ...
  { code: "2092", description: "PREPARED FRESH OR FROZEN FISH & SEAFOODS" },
  { code: "2100", description: "TOBACCO PRODUCTS" },
  { code: "2111", description: "CIGARETTES" },
  { code: "2200", description: "TEXTILE MILL PRODUCTS" },
  { code: "2211", description: "BROADWOVEN FABRIC MILLS, COTTON" },
  {
    code: "2221",
    description: "BROADWOVEN FABRIC MILLS, MAN MADE FIBER & SILK",
  },
  { code: "2250", description: "KNITTING MILLS" },
  { code: "2253", description: "KNIT OUTERWEAR MILLS" },
  { code: "2273", description: "CARPETS & RUGS" },
  {
    code: "2300",
  ...
  { code: "2330", description: "WOMEN'S, MISSES', AND JUNIORS OUTERWEAR" },
  {
    code: "2340",
    description: "WOMEN'S, MISSES', CHILDREN'S & INFANTS' UNDERGARMENTS",
  },
  { code: "2390", description: "MISCELLANEOUS FABRICATED TEXTILE PRODUCTS" },
  { code: "2400", description: "LUMBER & WOOD PRODUCTS (NO FURNITURE)" },
  { code: "2421", description: "SAWMILLS & PLANING MILLS, GENERAL" },
  {
    code: "2430",
    description: "MILLWOOD, VENEER, PLYWOOD, & STRUCTURAL WOOD MEMBERS",
  },
  { code: "2451", description: "MOBILE HOMES" },
  { code: "2452", description: "PREFABRICATED WOOD BLDGS & COMPONENTS" },
  { code: "2510", description: "HOUSEHOLD FURNITURE" },
  { code: "2520", description: "OFFICE FURNITURE" },
  { code: "2590", description: "MISCELLANEOUS FURNITURE & FIXTURES" },
  { code: "2600", description: "PAPERS & ALLIED PRODUCTS" },
  {
    code: "2711",
    description: "NEWSPAPERS: PUBLISHING OR PUBLISHING & PRINTING",
  },
  { code: "2731", description: "BOOKS: PUBLISHING OR PUBLISHING & PRINTING" },
  { code: "2750", description: "COMMERCIAL PRINTING" },
  { code: "2800", description: "CHEMICALS & ALLIED PRODUCTS" },
  { code: "2834", description: "PHARMACEUTICAL PREPARATIONS" },
  { code: "2911", description: "PETROLEUM REFINING" },
  { code: "3011", description: "TIRES & INNER TUBES" },
  { code: "3089", description: "PLASTICS PRODUCTS, NEC" },
  {
    code: "3310",
    description: "STEEL WORKS, BLAST FURNACES & ROLLING & FINISHING MILLS",
  },
  { code: "3411", description: "METAL CANS" },
  { code: "3510", description: "ENGINES & TURBINES" },
  { code: "3531", description: "CONSTRUCTION MACHINERY & EQUIP" },
  { code: "3571", description: "ELECTRONIC COMPUTERS" },
  {
    code: "3600",
    description: "ELECTRONIC & OTHER ELECTRICAL EQUIPMENT (NO COMPUTER EQUIP)",
  },
  { code: "3674", description: "SEMICONDUCTORS & RELATED DEVICES" },
  { code: "3711", description: "MOTOR VEHICLES & PASSENGER CAR BODIES" },
  { code: "3721", description: "AIRCRAFT" },
  {
    code: "3812",
    description: "SEARCH, DETECTION, NAVIGATION, GUIDANCE SYSTEMS",
  },
  { code: "3841", description: "SURGICAL & MEDICAL INSTRUMENTS & APPARATUS" },
  { code: "4011", description: "RAILROADS, LINE-HAUL OPERATING" },
  { code: "4512", description: "AIR TRANSPORTATION, SCHEDULED" },
  { code: "4813", description: "TELEPHONE COMMUNICATIONS (NO RADIOTELEPHONE)" },
  { code: "4911", description: "ELECTRIC SERVICES" },
  {
    code: "5045",
    description: "WHOLESALE-COMPUTERS & PERIPHERAL EQUIPMENT & SOFTWARE",
  },
  { code: "5411", description: "RETAIL-GROCERY STORES" },
  { code: "5734", description: "RETAIL-COMPUTER & COMPUTER SOFTWARE STORES" },
  { code: "5812", description: "RETAIL-EATING PLACES" },
  { code: "6021", description: "NATIONAL COMMERCIAL BANKS" },
  {
    code: "6211",
    description: "SECURITY BROKERS, DEALERS & FLOTATION COMPANIES",
  },
  { code: "6311", description: "LIFE INSURANCE" },
  { code: "6513", description: "OPERATORS OF APARTMENT BUILDINGS" },
  { code: "7011", description: "HOTELS & MOTELS" },
  { code: "7371", description: "SERVICES-COMPUTER PROGRAMMING SERVICES" },
  ...
  { code: "8111", description: "SERVICES-LEGAL SERVICES" },
  { code: "8711", description: "SERVICES-ENGINEERING SERVICES" },
  {
    code: "8731",
    description: "SERVICES-COMMERCIAL PHYSICAL & BIOLOGICAL RESEARCH",
  },
  { code: "8888", description: "FOREIGN GOVERNMENTS" },
  { code: "9721", description: "INTERNATIONAL AFFAIRS" },
  { code: "9995", description: "NON-OPERATING ESTABLISHMENTS" },
];
